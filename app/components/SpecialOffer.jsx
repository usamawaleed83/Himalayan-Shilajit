                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-md w-full transform rotate-3 hover:rotate-0 transition-transform duration-300">
                            ...
                            <Link href="/products" className="block w-full bg-primary text-white text-center py-4 rounded-xl font-bold hover:bg-primary-dark transition-colors shadow-lg hover:shadow-xl">
                                Shop Now & Save 20%
                            </Link>
