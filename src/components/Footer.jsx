      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-serif font-bold mb-4">Himalayan Shilajit</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Premium quality Himalayan Shilajit products sourced directly from the mountains.
              Experience the ancient wisdom of nature.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products" className="text-gray-300 hover:text-gold transition-colors duration-200">
                  Products
                </Link>
              </li>
              <li>
                <a href="#benefits" className="text-gray-300 hover:text-gold transition-colors duration-200">
                  Benefits
                </a>
              </li>
              <li>
                <a href="#faq" className="text-gray-300 hover:text-gold transition-colors duration-200">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:support@himalayanshilajit.com" className="hover:text-gold transition-colors">support@himalayanshilajit.com</a>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded text-white placeholder-gray-400 focus:outline-none focus:border-gold transition-colors"
                required
              />
              <button
                type="submit"
                className="w-full bg-gold text-primary px-4 py-2 rounded font-medium hover:bg-gold-dark transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-gray-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Himalayan Shilajit. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
