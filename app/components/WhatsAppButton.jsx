...
const WhatsAppButton = () => {
  ...
  const whatsappNumber = '923492832456'; // Your WhatsApp number
    ...
    <div className="fixed bottom-28 right-6 z-50">
      <div className="relative">
        ...
        <button
          ...
          className="bg-green hover:bg-green/90 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110"
