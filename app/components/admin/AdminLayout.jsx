                ...
                <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="text-center mt-4">
                            <Link href="/" className="text-sm text-gray-500 hover:text-primary">← Back to Store</Link>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-primary text-white flex-shrink-0 hidden md:flex flex-col">
                <div className="p-6 border-b border-white/10">
                    <h1 className="text-xl font-bold font-serif">HerbalSource Admin</h1>
                </div>
                <nav className="flex-1 p-4 space-y-2">
                    <Link
                        href="/admin/products"
                        className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${pathname?.includes('/products')
                    ...
                    <Link
                        href="/admin/orders"
                        className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${pathname?.includes('/orders')
                                ? 'bg-gold text-primary font-bold'
                                : 'hover:bg-white/10'
                            }`}
                    >
