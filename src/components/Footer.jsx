      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-serif font-bold mb-4">HerbalSource</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Premium quality herbal products sourced directly from nature.
              Experience the ancient wisdom of natural wellness.
            </p>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-gray-300 text-sm">
          <p>&copy; {new Date().getFullYear()} HerbalSource. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
